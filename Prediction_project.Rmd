...
dataset <- read.csv("C:/License Arius/pml-training.csv", na.strings = c("NA",""))
validation_set <- read.csv("C:/License Arius/pml-testing.csv", na.strings = c("NA",""))
```
...
# We can see that the database contain variable with NAs.
...
dim(dataset_cleaned)
```
# we remove 100 variables from the original dataset.
# We now remove useless colomns such as "X", "user_name" etc.
